...
const translations = {
  pt: {
    ...
    cadenceTitle: "Sua Cadência:",
    lastMeasurementLabel: "Última medição:",
    targetLabel: "Alvo:",
    liveCadenceLabel: "Tempo real:",
    measuring: "medindo...",
    ...
    trackBpmLabel: "BPM:",
    trackGenreSuffix: "{source} (Gênero: {genre})",
    bpmPerMin: "{n} / min",
  ...
  en: {
    ...
    cadenceTitle: "Your Cadence:",
    lastMeasurementLabel: "Last measurement:",
    targetLabel: "Target:",
    liveCadenceLabel: "Live:",
    measuring: "measuring...",
    ...
    trackSourceLabel: "Playlist:",
    trackBpmLabel: "BPM:",
    trackGenreSuffix: "{source} (Genre: {genre})",
    bpmPerMin: "{n} / min",
